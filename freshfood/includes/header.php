<?php
    ...
    session_start();
    define("APPURL", "http://localhost/FreshFood");
    
    define("IMGURLCATEGORY", "http://localhost/FreshFood/admin-panel/categories-admins/img_category");
    define("IMGURLPRODUCT", "http://localhost/FreshFood/admin-panel/products-admins/img_product");
